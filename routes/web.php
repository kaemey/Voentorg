...
Route::get('/admin/subcategory/add', [AdminController::class, 'subcategory_create']);
Route::get('/admin/subcategory/edit/{subcategory_id}', [AdminController::class, 'subcategory_edit']);
Route::post('/admin/subcategory', [AdminController::class, 'subcategory_store']);
Route::get('/admin/subcategory/edit', [AdminController::class, 'subcategory_select']);
Route::post('/admin/subcategory/edit/{subcategory_id}', [AdminController::class, 'subcategory_update']);
Route::post('/admin/subcategory/delete/{subcategory_id}', [AdminController::class, 'subcategory_delete']);
